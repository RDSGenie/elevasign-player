...
import com.elevasign.player.di.AppModule;
import com.elevasign.player.di.DatabaseModule;
...
import com.elevasign.player.worker.HeartbeatWorker_HiltModule;
import com.elevasign.player.worker.SyncWorker_HiltModule;
import dagger.Binds;
...
public final class ElevaSignApp_HiltComponents {
  private ElevaSignApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements ElevaSignApp_GeneratedInjector,
